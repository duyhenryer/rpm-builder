...
Source2:        voter-api
Source3:        micro-platform.conf
Source4:        micro-platform-redis.conf
Source5:        micro-platform-infra.target
Source6:        micro-platform-all.target
Source7:        micro-platform-user-api.service
Source8:        micro-platform-checkout-api.service
Source9:        micro-platform-voter-api.service
...
# Copy Go binaries
cp %{_sourcedir}/user-api %{buildroot}/opt/micro-platform/apps/user-api/user-api
cp %{_sourcedir}/checkout-api %{buildroot}/opt/micro-platform/apps/checkout-api/checkout-api
cp %{_sourcedir}/voter-api %{buildroot}/opt/micro-platform/apps/voter-api/voter-api
...
portCheck=$(ss -tuln | grep -E ":(80|6379|8080|8081|8082) " || true)
if [ -n "$portCheck" ]; then
    echo "[ERROR] Required ports (80, 6379, 8080, 8081, 8082) are not available:" >&2
    echo "$portCheck" >&2
